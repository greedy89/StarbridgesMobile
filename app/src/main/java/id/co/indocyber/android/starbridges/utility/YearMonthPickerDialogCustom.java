...
public class YearMonthPickerDialogCustom implements Dialog.OnClickListener {
    /**
     ...
     */
    private com.twinkle94.monthyearpicker.picker.YearMonthPickerDialog.OnDateSetListener mOnDateSetListener;
     ...
     */
    public YearMonthPickerDialogCustom(Context context, com.twinkle94.monthyearpicker.picker.YearMonthPickerDialog.OnDateSetListener onDateSetListener) {
     ...
     */
    public YearMonthPickerDialogCustom(Context context, com.twinkle94.monthyearpicker.picker.YearMonthPickerDialog.OnDateSetListener onDateSetListener, int theme) {
     ...
     */
    public YearMonthPickerDialogCustom(Context context, com.twinkle94.monthyearpicker.picker.YearMonthPickerDialog.OnDateSetListener onDateSetListener, int theme, int titleTextColor) {
        mContext = context;
    ...
    public void onClick(DialogInterface dialog, int which) {
        switch (which) {
            ...
            case DialogInterface.BUTTON_POSITIVE:
                ...
                selectedCalendar.set(mYear,mMonth, 01);
                ...
                if(selectedCalendar.before(calendar))
                    Toast.makeText(mContext, "Please select more than or equal "+new SimpleDateFormat("MMMM").format(calendar.getTime())+" "+ calendar.get(Calendar.YEAR), Toast.LENGTH_SHORT).show();
                else
                    break;
