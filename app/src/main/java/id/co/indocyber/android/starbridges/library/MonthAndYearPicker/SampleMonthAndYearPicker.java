package id.co.indocyber.android.starbridges.library.MonthAndYearPicker;
...
public class SampleMonthAndYearPicker extends AppCompatActivity {
    ...
    private void setNormalPicker() {
        ...
        findViewById(R.id.month_picker).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(SampleMonthAndYearPicker.this, new MonthPickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(int selectedMonth, int selectedYear) {
                        Log.d(TAG, "selectedMonth : " + selectedMonth + " selectedYear : " + selectedYear);
                        Toast.makeText(SampleMonthAndYearPicker.this, "Date set with month" + selectedMonth + " year " + selectedYear, Toast.LENGTH_SHORT).show();
                    }
        ...
        findViewById(R.id.imgPeriodPicker).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar cal = Calendar.getInstance();
                DatePickerDialog dialog = new DatePickerDialog(SampleMonthAndYearPicker.this, null, 2017,
    ...
    private void setBottleView() {
        ...
        LinearLayout chooseQty = (LinearLayout) findViewById(R.id.linearLayout);
        final TextView qty = (TextView) findViewById(R.id.txtAttachment);
