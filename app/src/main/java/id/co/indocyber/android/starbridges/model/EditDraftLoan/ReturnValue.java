...
public class ReturnValue implements Serializable, Parcelable
{
     ...
     */
    public ReturnValue(String iD, String employeeID, Integer employeeLoanBalanceID, Object decisionNumber, Integer transactionStatusID, Integer loanTransactionTypeID, String loanTransactionType, Object loanTransactionTypeLookUp, Integer loanPolicyID, Object loanPolicyLookUp, String startNewLoanDate, Integer creditAmount, Integer employeeLoanScheduleID, Integer amount, String description, Object loanSettingName, Object limit, Boolean fullAccess, List<Object> exclusionFields, String accessibilityAttribute) {
        super();
        this.iD = iD;
    ...
    public Integer getEmployeeLoanScheduleID() {
